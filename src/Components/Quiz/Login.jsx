    ...
    <div className='container'>
      <div className='flex flex-col justify-center mt-32 mx-auto   h-auto md:w-1/3'>
        <form onSubmit={(e) => e.preventDefault()} className='flex flex-col gap-4 '>
          <h1 onClick={toggleSignInForm} className="text-black  font-bold text-center text-4xl mt-12 mb-4 px-4">
          ...
          <p className="cursor-pointer text-black" onClick={toggleSignInForm}>
